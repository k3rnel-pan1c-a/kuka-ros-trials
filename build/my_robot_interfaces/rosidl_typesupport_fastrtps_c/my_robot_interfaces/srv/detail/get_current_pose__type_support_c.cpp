...
#include "my_robot_interfaces/srv/detail/get_current_pose__rosidl_typesupport_fastrtps_c.h"
...
using _GetCurrentPose_Request__ros_msg_type = my_robot_interfaces__srv__GetCurrentPose_Request;
...
size_t get_serialized_size_my_robot_interfaces__srv__GetCurrentPose_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetCurrentPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__srv__GetCurrentPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_my_robot_interfaces__srv__GetCurrentPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces__srv__GetCurrentPose_Request;
    is_plain =
      (
...
static size_t _GetCurrentPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__srv__GetCurrentPose_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, srv, GetCurrentPose_Request)() {
...
using _GetCurrentPose_Response__ros_msg_type = my_robot_interfaces__srv__GetCurrentPose_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t get_serialized_size_my_robot_interfaces__srv__GetCurrentPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetCurrentPose_Response__ros_msg_type * ros_message = static_cast<const _GetCurrentPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__srv__GetCurrentPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_my_robot_interfaces__srv__GetCurrentPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces__srv__GetCurrentPose_Response;
    is_plain =
      (
...
static size_t _GetCurrentPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__srv__GetCurrentPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, srv, GetCurrentPose_Response)() {
...
// already included above
// #include "my_robot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_robot_interfaces/srv/get_current_pose.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, srv, GetCurrentPose)() {
