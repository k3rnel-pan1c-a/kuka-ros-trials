...
class Metaclass_GetCurrentPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.srv.GetCurrentPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_interfaces.srv import _get_current_pose
...
class GetCurrentPose(metaclass=Metaclass_GetCurrentPose):
    from my_robot_interfaces.srv._get_current_pose import GetCurrentPose_Request as Request
    from my_robot_interfaces.srv._get_current_pose import GetCurrentPose_Response as Response
