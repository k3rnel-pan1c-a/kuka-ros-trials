...
#include "my_robot_interfaces/srv/detail/get_current_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::srv::GetCurrentPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::srv::GetCurrentPose_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::srv::GetCurrentPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::GetCurrentPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::srv::GetCurrentPose_Request *>(
    untyped_ros_message);
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetCurrentPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, GetCurrentPose_Request)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetCurrentPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::srv::GetCurrentPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: x
  cdr << ros_message.x;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::srv::GetCurrentPose_Response & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::srv::GetCurrentPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::GetCurrentPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::srv::GetCurrentPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetCurrentPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, GetCurrentPose_Response)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetCurrentPose_Response__handle;
}
...
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetCurrentPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, GetCurrentPose)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_GetCurrentPose__handle;
}
